...
const Login = () => {
  return (
    <div className="bg-white relative">
      <div
        className="flex overflow-hidden flex-col items-center justify-between pt-0 pr-10 pb-0 pl-10 mt-0 mr-auto mb-0 ml-auto max-w-7xl xl:px-5 lg:flex-row "
      >
        <div className="flex flex-col items-center w-full pt-5 pr-10 pb-20 lg:pb-0 pl-10 lg:pt-0 lg:flex-row">
          ...
          <div className="w-[20rem] mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
            <div
              ...
              <div className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="password"
                    className="border placeholder-gray-400 focus:outline-none focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-whiteborder-gray-300 rounded-md"
                  />
                </div>
