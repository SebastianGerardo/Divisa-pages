...
const Footer = () => {
  return (
  <footer className="grow bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
    {/* CONTENT DESCRIPCION PAGE */}
    <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        {/* CONTENT INFO PAGE */}
        <div>
          {/* LOGO FOOTER */}
          <img className="mr-5 h-6 sm:h-9 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="" />
